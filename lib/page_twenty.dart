...
class _PageTwentyState extends State<PageTwenty>
  ...
  void initState() {
    ...
    playVoiceOverAudio('assets/hal_20.mp3'); // Memulai voice over
    playVoiceOverAudio('assets/hal_20.mp3');
  }
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => PageNineth()),
                        );
                      },
                      iconSize: width * 0.1,
                    ),
