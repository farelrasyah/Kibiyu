...
import 'package:kibiyu/page_ten.dart';
...
class _PageElevenState extends State<PageEleven> with SingleTickerProviderStateMixin, WidgetsBindingObserver  {
  ...
  playVoiceOverAudio('assets/hal_11.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_11.mp3');
  }
...
void didChangeAppLifecycleState(AppLifecycleState state) {
  ...
  Route _createRouteBack() {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) => PageTen(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
