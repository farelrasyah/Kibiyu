...
import 'package:kibiyu/page_thirty.dart';
import 'package:kibiyu/page_twentyeight.dart';
import 'home_page.dart';

class PageTwentyNine extends StatefulWidget {
  @override
  _PageTwentyNineState createState() => _PageTwentyNineState();
}

class _PageTwentyNineState extends State<PageTwentyNine>
  ...
  void initState() {
    ...
    playVoiceOverAudio('assets/hal_29.mp3'); // Memulai voice over
    playVoiceOverAudio('assets/hal_29.mp3');
  }
...
void playBackgroundAudio(String path) async {
  ...
  Route _createRoute() {
    return PageRouteBuilder(
      transitionDuration: Duration(milliseconds: 800),
      pageBuilder: (context, animation, secondaryAnimation) => PageThirty(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        var begin = Offset(1.0, 0.0);
        var end = Offset.zero;
        var curve = Curves.easeInOutQuint;
