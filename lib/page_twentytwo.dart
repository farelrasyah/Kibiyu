...
import 'package:kibiyu/page_twentyone.dart';
import 'package:kibiyu/page_twentythree.dart';
import 'home_page.dart';



class PageTwentyTwo extends StatefulWidget {
  @override
  _PageTwentyTwoState createState() => _PageTwentyTwoState();
}

class _PageTwentyTwoState extends State<PageTwentyTwo > with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  playVoiceOverAudio('assets/hal_22.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_22.mp3');
  }
 ...
 void playBackgroundAudio(String path) async {
  ...
  Route _createRouteBack() {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) => PageTwentyOne(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
