...
class _PageTwelveState extends State<PageTwelve> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  playVoiceOverAudio('assets/hal_12.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_12.mp3');
  }
