...
import 'package:kibiyu/page_twenty.dart';
import 'package:kibiyu/page_twentytwo.dart';
import 'home_page.dart';

class PageTwentyOne extends StatefulWidget {
  @override
  _PageTwentyOneState createState() => _PageTwentyOneState();
}

class _PageTwentyOneState extends State<PageTwentyOne>
  ...
  void initState() {
    ...
    playVoiceOverAudio('assets/hal_21.mp3'); // Memulai voice over
    playVoiceOverAudio('assets/hal_21.mp3');
  }
  ...
  Route _createRouteBack() {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) => PageTwenty(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
