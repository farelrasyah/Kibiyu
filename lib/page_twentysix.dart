...
class PageTwentySix extends StatefulWidget {
  @override
  _PageTwentySixState createState() => _PageTwentySixState();
}

class _PageTwentySixState extends State<PageTwentySix>
 ...
 AudioPlayer backgroundAudioPlayer = AudioPlayer();
  ...
  playVoiceOverAudio('assets/hal_26.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_26.mp3');
  }
