...
import 'package:kibiyu/page_fiveteen.dart';
import 'package:kibiyu/page_thirteen.dart';
import 'home_page.dart';


class PageFourth extends StatefulWidget {
  @override
  _PageFourthState createState() => _PageFourthState();
}

class _PageFourthState extends State<PageFourth> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  playVoiceOverAudio('assets/hal_14.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_14.mp3');
  }
  ...
  Route _createRouteBack() {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) => PageThirth(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
  ...
  Route _createRouteForward() {
    return PageRouteBuilder(
      transitionDuration: Duration(milliseconds: 800),
      pageBuilder: (context, animation, secondaryAnimation) => PageFiveth(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        var begin = Offset(1.0, 0.0);
        var end = Offset.zero;
        var curve = Curves.easeInOutQuint;
