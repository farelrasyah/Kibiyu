...
import 'package:kibiyu/page_twentyfive.dart';
import 'package:kibiyu/page_twentythree.dart';
import 'home_page.dart';

class PageTwentyFour extends StatefulWidget {
  @override
  _PageTwentyFourState createState() => _PageTwentyFourState();
}

class _PageTwentyFourState extends State<PageTwentyFour> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  void initPlayers() async {
    ...
    playVoiceOverAudio('assets/hal_24.mp3'); // Memulai voice over
  }
 ...
 void playBackgroundAudio(String path) async {
  ...
  void toggleAudio() {
    if (isPlaying || isVoiceOverPlaying) {
      ...
      playVoiceOverAudio('assets/hal_24.mp3');
      setState(() {
  ...
  Route _createRouteBack() {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) => PageTwentyThree(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
  ...
  Route _createRouteForward() {
    return PageRouteBuilder(
      transitionDuration: Duration(milliseconds: 800),
      pageBuilder: (context, animation, secondaryAnimation) => PageTwentyFive(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        var begin = Offset(1.0, 0.0);
        var end = Offset.zero;
        var curve = Curves.easeInOutQuint;
