...
class _PageSixState extends State<PageSix> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  playVoiceOverAudio('assets/hal_6.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_6.mp3');
  }
