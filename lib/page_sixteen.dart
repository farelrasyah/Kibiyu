...
class PageSixth extends StatefulWidget {
  @override
  _PageSixthState createState() => _PageSixthState();
}

class _PageSixthState extends State<PageSixth>
 ...
 AudioPlayer backgroundAudioPlayer = AudioPlayer();
  ...
  playVoiceOverAudio('assets/hal_16.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_16.mp3');
  }
