...
import 'package:kibiyu/page_eightteen.dart';
import 'package:kibiyu/page_sixteen.dart';
import 'home_page.dart';


class PageSeventh extends StatefulWidget {
  @override
  _PageSeventhState createState() => _PageSeventhState();
}

class _PageSeventhState extends State<PageSeventh> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  playVoiceOverAudio('assets/hal_17.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_17.mp3');
  }
  ...
  Route _createRouteBack() {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) => PageSixth(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
  ...
  Route _createRouteForward() {
    return PageRouteBuilder(
      transitionDuration: Duration(milliseconds: 800),
      pageBuilder: (context, animation, secondaryAnimation) => PageEightth(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        var begin = Offset(1.0, 0.0);
        var end = Offset.zero;
        var curve = Curves.easeInOutQuint;
