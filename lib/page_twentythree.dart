...
import 'package:kibiyu/page_twentyfour.dart';
import 'package:kibiyu/page_twentytwo.dart';
import 'home_page.dart';




class PageTwentyThree extends StatefulWidget {
  @override
  _PageTwentyThreeState createState() => _PageTwentyThreeState();
}

class _PageTwentyThreeState extends State<PageTwentyThree > with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  playVoiceOverAudio('assets/hal_23.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_23.mp3');
  }
  ...
  Route _createRouteBack() {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) => PageTwentyTwo(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
  ...
  Route _createRouteForward() {
    return PageRouteBuilder(
      transitionDuration: Duration(milliseconds: 800),
      pageBuilder: (context, animation, secondaryAnimation) => PageTwentyFour(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        var begin = Offset(1.0, 0.0);
        var end = Offset.zero;
        var curve = Curves.easeInOutQuint;
