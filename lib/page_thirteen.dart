...
import 'package:kibiyu/page_fourteen.dart';
import 'package:kibiyu/page_twelve.dart';
import 'home_page.dart';


class PageThirth extends StatefulWidget {
  @override
  _PageThirthState createState() => _PageThirthState();
}

class _PageThirthState extends State<PageThirth> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  playVoiceOverAudio('assets/hal_13.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_13.mp3');
  }
 ...
 void playBackgroundAudio(String path) async {
  ...
  Route _createRouteBack() {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) => PageTwelve(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
  ...
  Route _createRouteForward() {
    return PageRouteBuilder(
      transitionDuration: Duration(milliseconds: 800),
      pageBuilder: (context, animation, secondaryAnimation) => PageFourth(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        var begin = Offset(1.0, 0.0);
        var end = Offset.zero;
        var curve = Curves.easeInOutQuint;
