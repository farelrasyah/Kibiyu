...
class _PageNineState extends State<PageNine> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  playVoiceOverAudio('assets/hal_9.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_9.mp3');
  }
