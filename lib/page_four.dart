...
import 'package:kibiyu/page_five.dart';
import 'package:kibiyu/page_three.dart';
...
class _PageFourState extends State<PageFour>
  ...
  playVoiceOverAudio('assets/hal_4.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_4.mp3');
  }
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Transform.translate(
                      offset: Offset(0, 60 * _scaleAnimation!.value - 10),
                      child: Image.asset(
                        'assets/karakter4.png',
                        width: width * 0.7,
                        fit: BoxFit.cover,
                      ),
                    );
  ...
  Route _createRouteBack() {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) => PageThree(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
  ...
  Route _createRouteForward() {
    return PageRouteBuilder(
      transitionDuration: Duration(milliseconds: 800),
      pageBuilder: (context, animation, secondaryAnimation) => PageFive(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        var begin = Offset(1.0, 0.0);
        var end = Offset.zero;
        var curve = Curves.easeInOutQuint;
