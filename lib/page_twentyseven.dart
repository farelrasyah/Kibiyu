...
import 'package:kibiyu/page_twentyeight.dart';
import 'package:kibiyu/page_twentysix.dart';
import 'home_page.dart';




class PageTwentySeven extends StatefulWidget {
  @override
  _PageTwentySevenState createState() => _PageTwentySevenState();
}

class _PageTwentySevenState extends State<PageTwentySeven > with SingleTickerProviderStateMixin , WidgetsBindingObserver{
  ...
  playVoiceOverAudio('assets/hal_27.mp3'); // Memulai voice over
     playVoiceOverAudio('assets/hal_27.mp3');
  }
  ...
  Route _createRouteBack() {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) => PageTwentySix(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
  ...
  Route _createRouteForward() {
    return PageRouteBuilder(
      transitionDuration: Duration(milliseconds: 800),
      pageBuilder: (context, animation, secondaryAnimation) => PageTwentyEight(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        var begin = Offset(1.0, 0.0);
        var end = Offset.zero;
        var curve = Curves.easeInOutQuint;
